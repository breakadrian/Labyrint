...
class Labyrint {
  ...
  public int antallVeier;
  public String lagretKolonneRad;
...
/*ved å låse denne metoden gjør vi den til en dedikert monitor. Dette forhindrer at vi returnerer utveilisten
*før vi har avsluttet alle trådene
*/
